...
<body>
  <nav class="navbar navbar-inverse">
    ...
    <h2><strong><center>Acerca de mí</center></strong></h2>
    <p class="bg-danger">
      <h2>Soy Arlet Medina, soy la responsable de la creacion de este crud el cual es de una base de datos donde ingresas peliculas
